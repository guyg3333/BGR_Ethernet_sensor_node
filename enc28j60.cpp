...
// read upper 8 bits
uint16_t enc28j60::enc28j60PhyReadH(uint8_t address)
{
...
void enc28j60::enc28j60PacketSend(uint16_t len, uint8_t* packet)
{
...
uint16_t enc28j60::enc28j60PacketReceive(uint16_t maxlen, uint8_t* packet)
{
	uint16_t rxstat;
	uint16_t len;
